[![Run App Sigerson, Cale](https://github.com/Mawasu/GithubActions/actions/workflows/run-app.yml/badge.svg)](https://github.com/Mawasu/GithubActions/actions/workflows/run-app.yml)
